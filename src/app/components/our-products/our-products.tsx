        ...
        <div className=" overflow-hidden w-full bg-secondary">
            ...
            <div className="xl:w-[1236px] xl:m-auto  ">
                ...
                <div className="grid grid-cols-1 justify-items-center gap-10 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 rounded-[5px]">
                    ...
                    {/* card-2 */}
                    <div className="w-[285px] h-[446px] bg-[#F4F5F7] rounded-[5px] lg:hidden xl:block relative transition-transform transform hover:scale-105 hover:translate-y-2 duration-500 ease-out">
                    ...
                    {/* card-5 */}
                    <div className="w-[285px] h-[446px]  rounded-[5px] bg-[#F4F5F7] transition-transform transform hover:scale-105 hover:translate-y-2 duration-500 ease-out">
...
// w-[285px] h-[446px] opacity-0 transform translate-y-[-100%] transition-all duration-200 ease-in-out hover:translate-y-0 hover:bg-[#3A3A3A] hover:opacity-[72%] absolute inset-0 rounded-[5px] group


// w-[285px] h-[446px] opacity-0 transform translate-y-10 transition-all duration-200 ease-in-out hover:translate-y-0 hover:bg-[#3A3A3A] hover:opacity-[72%] absolute inset-0 rounded-[5px]